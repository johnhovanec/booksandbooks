...
app.use(logger('dev')); // logging to dev level
//app.use(logger({ format: ' :http-version :remote-addr :method :url :req[header] :res[header]' }));
...
app.get('/pageNext/:skip', booksController.pageNext);
